...
public class MeargeReq1 {
	...
	public static void main(String[] args) {
		int[]arr1 ={12,34,56,77,88,99,29};
		int[]arr2 ={112,344,556,767,11,22,33,44,55,99,29};
		...
		System.out.println("_______sift1_____________");
	...
	System.out.println("_______sift2_____________");
	System.out.println("new array = "+java.util.Arrays.toString(mergeArr));
