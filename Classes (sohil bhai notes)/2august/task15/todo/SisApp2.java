 ...
 */
 ...
 public class SisApp2 {
	...
	*/
	...
	java.io.Console con  = System.console();   //1.6 jdk feature 
	String inputLoginId =null;
	String inputLoginPassword = null;
	
	System.out.print("Enter login id>>");
	inputLoginId=con.readLine();//scan.nextLine();
	System.out.print("Enter login password>>");
	//inputLoginPassword=scan.nextLine();

	char []passwordArr = con.readPassword();
	inputLoginPassword=new String(passwordArr);
								//OR short form
	//inputLoginPassword=new String(con.readPassword());
