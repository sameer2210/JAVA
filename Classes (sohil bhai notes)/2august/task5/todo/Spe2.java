 ...
 */
 ...
 public class Spe2 {
	...
	public static void main(String args[]){
	   ...
	   //set 1
	   System.out.println("set1 "+ data[0]);
	   System.out.println("set1 total element "+ data[0].length);
	   System.out.println("set2 "+ data[1]);
	   System.out.println("set1 total element "+ data[1].length);
	   //set 2
	   ...
	   System.out.println("_______after update___________");
