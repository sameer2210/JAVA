...
public class User {
	...
	private static int [] pickedNumbersList;
	...
	static{
		COMMAN_GAME_NUMBER_LIST_SIZE=20;//db 
		USER_NUMBER_LIST_SIZE=5;//db
		pickedNumbersList=new int[COMMAN_GAME_NUMBER_LIST_SIZE];
	...
	//object block
	{
		...
		//fill with unique numbers from comman game number list
		int position=1;
		while(true){
