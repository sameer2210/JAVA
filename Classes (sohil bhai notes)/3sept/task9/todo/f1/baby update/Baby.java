public class Baby {
	...
	this.weight=weight;
	this.fit=fit;
	System.out.println(this +"  created with 6 arg constructor...");
	}
	...
	public boolean isFit() { // boolean get method start with IsXxx
		return fit;
	}
	...
	void allDetails(){
		System.out.println("_____________"+this + " details ______________");
